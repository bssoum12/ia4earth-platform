...
const FAQ = [
  ...
  },
  {
    ...
    a: "Le concours cible prioritairement les startups tunisiennes et africaines. Si votre projet a un lien direct avec la Tunisie ou l'Afrique (équipe, marché, impact), votre dossier sera examiné. Contactez-nous à contact@ia4earth.tn pour toute question spécifique.",
  },
  {
